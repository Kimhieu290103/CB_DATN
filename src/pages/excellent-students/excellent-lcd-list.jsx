...
import { useGetCompletedLcdCriteriaQuery } from "@/api/rtkQuery/featureApi/criteriaApiSlice"; // Import đúng hook
...
const ExcellentLcdList = () => {
    ...
    const { data: excellentStudents, isLoading, error } = useGetCompletedLcdCriteriaQuery(selectedYear);
    ...
    return (
        <>
            <h1 className="text-2xl font-semibold mb-6">
                Danh sách các liên chi đoàn hoạt động tốt
            </h1>
            ...
            <Table>
                <TableHeader>
                    <TableRow>
                        ...
                        <TableHead className="w-[25rem]">Tên liên chi đoàn</TableHead>
...
export default ExcellentLcdList;
